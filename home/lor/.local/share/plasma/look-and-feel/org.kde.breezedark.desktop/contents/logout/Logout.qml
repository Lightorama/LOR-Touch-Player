    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            LogoutButton {
                ...
                focus: sdtype === ShutdownType.ShutdownTypeHalt || sdtype === ShutdownType.ShutdownTypeNone
                visible: maysd
            }
        ...
        PlasmaComponents.Label {
            ...
            text: i18ndp("plasma_lookandfeel_org.kde.lookandfeel", "Dismissing in 1 second", "Dismissing in %1 seconds", root.remainingTime)
        }
